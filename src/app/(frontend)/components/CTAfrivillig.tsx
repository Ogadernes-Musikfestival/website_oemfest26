  ...
  return (
    <Drawer.Root handle={frivilligDrawer} swipeDirection="right">
      <Drawer.Portal>
        ...
        <Drawer.Viewport className="fixed inset-0 top-[2.5%] flex justify-end">
          <Drawer.Popup className="text-dark h-11/12 w-full touch-pan-y overflow-hidden overflow-y-auto rounded-none bg-white p-6 sm:max-w-2xl sm:rounded-3xl sm:p-8 md:h-[90dvh] md:max-w-4xl md:p-12 lg:max-w-6xl">
